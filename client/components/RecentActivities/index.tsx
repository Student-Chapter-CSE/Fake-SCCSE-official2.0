...
const Recent: React.FC = () => {
  return (
    <div id="events" className=" w-full flex flex-col items-center">
      ...
      />
      <div className="w-full h-full ml-auto items-end justify-end ">
          ...
          <div className=" h-fit lg:w-[50.5rem] md:w-[42rem] phone:w-[17.5rem] pt-7">
...
export const Card: React.FC<CardProps> = ({
  ...
  return (
    <div
      className={`w-full h-full xl:w-full lg:w-[68rem] md:w-[48rem] flex flex-col items-end justify-end md:flex-row phone:items-center md:gap-10 phone:gap-5`}
    >
      <div
      ...
      >
        <motion.h1
          ...
          className="lg:text-[1.1rem] xl:text-[3rem] mxl:text-[2.5rem] md:text-[1.4rem] sm:text-[0.7rem] justify-end phone:text-[0.8rem] items-center flex text-primary_text font-montserrat"
        >
          {subText}
        </motion.h1>
        <div>
      ...
      >
        ...
        <Image
          ...
          alt="Event Image"
          fill
          style={{ objectFit: "contain" }} // If I want to show the fullposter then it will be objectFit:contain but then the datas will not be align :)
