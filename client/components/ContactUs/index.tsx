      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-[70%] border-t-[0.5px] border-primary_text gap-14 pt-5 pb-40">
          ...
          <div className="w-full flex flex-col items-end justify-center px-4 py-2 gap-3">
            <Link href="#" className={socialLinkStyle}>X<Arrow/></Link>
            <Link href="#" className={socialLinkStyle}>Facebook<Arrow/></Link>
            <Link href="#" className={socialLinkStyle}>LinkedIn<Arrow/></Link>
            <Link href="#" className={socialLinkStyle}>Instagram<Arrow/></Link>
            <Link href="#" className={socialLinkStyle}>sccseaot@gmail.com<Arrow/></Link>
          </div>
        </div>
      </div>
    </div>
