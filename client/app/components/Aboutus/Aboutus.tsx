...
const Aboutus: React.FC = () => {
  return (
    ...
    <div className="relative w-full h-fit items-center justify-center text-body leading-[1.3rem]">
      <Headertitle
        title="ABOUT"
        subtitle="US"
      ...
      <div className="flex flex-col justify-center items-center ">
        ...
        <div className="flex flex-col md:flex-row items-start justify-center w-fit pt-10 pb-40 gap-2 md:gap-72 border-t-[0.5px] border-primary_text ">
          <h4 className=" font-montserrat text-secondary_text ">
            Brief about us
          </h4>
          <div className="w-full flex flex-row max-w-lg item-start justify-center gap-2 left-0">
            ...
            <div className=" font-montserrat text-secondary_text ">
