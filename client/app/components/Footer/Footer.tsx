...
const Footer = () => {
  return (
    <div className='w-full h-fit flex flex-col bg-primary_text items-center justify-center pt-12 gap-11 px-4'>
      <hr className="border-b-[0.5px] border-secondary_text my-4 w-[70%]" />
      <div className='flex flex-col md:flex-row items-center justify-between w-full'>{/*make this div flex column in responsive*/}
